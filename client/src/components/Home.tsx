  ...
  return (
    <Box className={classes.mainContainer}>
      <Box className={classes.box}>
        <img className={classes.flag} src={image2} width="100%" height="100%" alt="Background Flag" />
        <Box className={classes.pictureBox}>
          ...
          <img src={image} className={classes.image} alt="PolyglotBot" />
      ...
      <Box className={classes.box2}>
        ...
        <Typography className={classes.aboutText}>
          PolyglotBot, powered by OpenAI, is designed to offer seamless interaction, adapting to your language preferences and conversation style. With a diverse linguistic capability, the chatbot can effortlessly switch between languages, making it ideal for multilingual individuals or those looking to practice a new language. It's not just about language translation; the AI comprehends cultural nuances and idioms, ensuring that conversations feel natural and relevant.
        </Typography>
      </Box>
        ...
        <Box className={classes.featuresBox}>
          <Paper className={classes.paperFeature}>
            ...
            <Typography className={classes.featuresDescription} variant="h5">
              Chat instantly with the AI chatbot through text messaging. Experience seamless conversations in over 30 languages. Whether you're seeking information, guidance, or just a friendly conversation, PolyglotBot is here to assist, making every interaction effortlessly informative and enjoyable.
            </Typography>
          </Paper>
          <Paper className={classes.paperFeature}>
            ...
            <Typography className={classes.featuresDescription} variant="h5">
              Break down language barriers with our real-time direct translation feature. Experience seamless communication across languages, ensuring accurate and natural conversations. Perfect for both personal and professional interactions, our direct translation bridges language gaps effortlessly.
            </Typography>
          </Paper>
          <Paper className={classes.paperFeature}>
            ...
            <Typography className={classes.featuresDescription} variant="h5">
              Elevate your experience with our live voice chat feature. Talk directly with the AI in a natural and conversational manner in your chosen language, while also enjoying real-time text translations. This feature replicates the dynamics of a phone call making every conversation as real as talking to a native speaker.
            </Typography>
          </Paper>
        </Box>
      </Box>
